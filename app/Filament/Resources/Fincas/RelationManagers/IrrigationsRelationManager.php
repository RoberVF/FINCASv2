...
class IrrigationsRelationManager extends RelationManager
{
    protected static string $relationship = 'irrigations';

    protected static ?string $title = 'Riegos';
